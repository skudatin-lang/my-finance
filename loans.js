...
// ── Локальная копия рабочего запроса к DeepSeek через proxyapi ──
...
// ── Переопределяем глобальную функцию для кнопки "Спросить ИИ" ──
window.getLoansAI = async function() {
  ...
  // Собираем данные о кредитах из кошельков с отрицательным балансом
...
// ── Дальше идёт исходный код renderLoans и renderLoansSummary (не меняется) ──
