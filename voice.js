  ...
  try{
    ...
    _recognition.onerror=e=>{
      ...
      const msgs={
        ...
        'network':'Нет интернета. Web Speech API требует подключения.',
        'aborted':'Запись отменена.',
      };
      onError&&onError(msgs[e.error]||'Ошибка распознавания: '+e.error);
    };
