...
const TOUR_STEPS = [
  {
    ...
    text: 'Быстрый тур по приложению — 8 шагов, меньше минуты. Покажем главное.',
    position: 'center',
    action: null,
  },
  {
    ...
    text: 'Главная кнопка. Записывайте доходы, расходы и переводы. Или просто скажите голосом — кнопка 🎤 справа внизу.',
    position: 'bottom',
    action: null,
  },
  {
    targetId: 'simple-main-amount',
    title: '💰 Главная цифра',
    text: 'Здесь всегда видно сколько можно потратить до конца месяца. Кольцо показывает процент использованного бюджета.',
    position: 'bottom',
  ...
  },
  {
    ...
    title: '📋 Отчёты',
    text: 'Баланс всех кошельков, операции по каждому кошельку и расходы по категориям за любой месяц.',
    position: 'bottom',
  ...
  },
  {
    ...
    title: '📅 Календарь',
    text: 'Операции по дням. Зелёные дни — есть записи. Здесь же список покупок.',
    position: 'bottom',
  ...
  },
  {
    targetId: 'tnav-dds',
    title: '💵 ДДС',
    text: 'Движение денежных средств — выполнение финансового плана. Видно сколько потрачено по каждой статье бюджета.',
    position: 'bottom',
  ...
  },
  {
    ...
    title: '⚙️ Настройки',
    text: 'Добавьте кошельки с реальными балансами и настройте финансовый план. Там же FAQ и поддержка.',
    position: 'bottom',
  ...
  },
  {
    ...
    text: 'Добавьте кошельки → внесите первую операцию → приложение начнёт строить аналитику. Если что-то непонятно — FAQ в Настройках или напишите нам.',
    position: 'center',
    action: null,
    isLast: true,
  },
